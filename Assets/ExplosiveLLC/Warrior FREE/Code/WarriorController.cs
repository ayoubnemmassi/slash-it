...
namespace WarriorAnimsFREE
{
    public class WarriorController : SuperStateMachine
    {
        ...
        [HideInInspector] public InputController warriorInputController;
        ...
        private void Awake()
        {
            ...
            warriorInputController = GetComponent<InputController>();
            ...
            {
                Debug.LogError("Custom input controller not used");
        ...
        private void GetInput()
        {
            if (allowedInput)
            {
                ...
                if (!useInputSystem)
                {
                    if (warriorInputController != null)
                    {
                        warriorInputController.CollectInputs();
                        inputAttack = warriorInputController.inputAttack;
                        inputJump = warriorInputController.inputJump;
                        inputJumpDirection = warriorInputController.inputJumpDirection;
        ...
        {
            SetAnimatorInt("Action", 1);
            SetAnimatorTrigger(AnimatorTrigger.SpinningAttackTrigger);
            Lock(true, true, true, 0, warriorTiming.TimingLock(warrior, "attack1"));
        }
        ...
        public void ResetAnimatorTriggerNumber()
        {
